...
public class FormKaryawan extends javax.swing.JInternalFrame {
    ...
    public final void refreshTable() {
        ...
        model.Karyawan karyawanModel = new model.Karyawan();
        if (karyawanModel.bacaData()) {
            Object[][] data = karyawanModel.getList();
            String[] jabatanNames = {"Manajer", "Supervisor", "Staff", "Admin"};
            for (Object[] row : data) {
                int ruangIndex = (int) row[2] - 1;
                String jabatan = (ruangIndex >= 0 && ruangIndex < jabatanNames.length) ? jabatanNames[ruangIndex] : "Staff";
                model.addRow(new Object[]{row[0], row[1], jabatan}); 
            }
        }
    }
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        // Capture data BEFORE controller clears it
        ...
        // Refresh table from database to ensure sync
        refreshTable();
