...
public class FormPekerjaan extends javax.swing.JInternalFrame {
    ...
    public final void refreshTable() {
        ...
        model.Pekerjaan pekerjaanModel = new model.Pekerjaan();
        if (pekerjaanModel.bacaData()) {
            Object[][] data = pekerjaanModel.getList();
            for (Object[] row : data) {
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        String gajiStr = gajiTextField.getText();
        ...
        javax.swing.JComboBox<String> dummyCombo = new javax.swing.JComboBox<>(new String[]{gajiStr.isEmpty() ? "0" : gajiStr});
